...
pink_btn = PhotoImage(file='Sensveria.png')
img_label = Label(image=pink_btn)

btn = Button(window, image=pink_btn, bd=0, command=open).place(x=200, y=100, height=300, width=300)

orLabel: Label = Label(text="Sensveria Birthday Plant"
                            "\nPrice : Rs.395 ", font=('Nova Oval Bold', 25), bg='light yellow', justify="left")
orLabel.place(x=200, y=450)
orLabel: Label = Label(text="● Product Details: "
                     "\nPlant Name- Sensveria Birthday Plant"
